...
# strict short-paragraph exact, and conservative contiguous multi-region
# paragraph recovery for items that still lack a usable PDF slot.
...
VERSION = "markdown-pdf-spine-wrapper-0.21"
...
def build_markdown_pdf_spine(
    ...
    result = _build_v21(markdown_map, pdf_analysis)
