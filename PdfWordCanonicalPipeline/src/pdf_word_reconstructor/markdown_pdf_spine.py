...
# recovery, non-destructive page-furniture isolation, and finally a conservative
# adjacent-page sequence-bracket paragraph recovery for still-unresolved long prose.
...
VERSION = "markdown-pdf-spine-wrapper-0.24"
...
def build_markdown_pdf_spine(
    ...
    result = _build_v24(markdown_map, pdf_analysis)
