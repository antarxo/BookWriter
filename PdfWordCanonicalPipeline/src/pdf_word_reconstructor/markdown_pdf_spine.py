...
# directional, conflict-aware, structural, and adjacent-page text recovery for
# items that still lack a usable PDF slot.
from typing import Any

from .markdown_pdf_page_alignment import infer_missing_markdown_pages
from .markdown_pdf_spine_v15 import build_markdown_pdf_spine as _build_v15


VERSION = "markdown-pdf-spine-wrapper-0.15"
...
def build_markdown_pdf_spine(
    ...
    result = _build_v15(markdown_map, pdf_analysis)
