...
## v0.3.0 — αυστηρό συμβόλαιο `book.json` — 2026-07-24

- Κάθε βιβλίο αποθηκεύεται αποκλειστικά ως `books/<book-id>/book.json`.
- Δεν υπάρχει fallback ή αναζήτηση ιστορικού ονόματος αρχείου.
- Το `meta.id`, `meta.title`, `meta.version` και `meta.language` είναι υποχρεωτικά.
- Το `meta.id` αποτελεί την ταυτότητα του βιβλίου και εμφανίζεται σε reader και editor.
- Αφαιρέθηκε πλήρως η έννοια γενικού συνδέσμου εφαρμογής από runtime, editor και navigation.
- Η εξαγωγή του editor παράγει πάντοτε `book.json`.
- Προστέθηκε repository validator για τη δομή βιβλίων και το αυστηρό συμβόλαιο.
...
- Ο reader και ο editor δέχονται πλέον ρητά
  `?book=<διεύθυνση-json>`.
- Εικόνες επιλύονται σε σχέση με το JSON του βιβλίου, ενώ κάθε σκηνή δηλώνει
  το δικό της πλήρες URL.
